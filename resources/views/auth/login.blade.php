...
@section('title', 'Login | Ajira Global')
...
<div class="container mx-auto px-4 py-12">
    <div class="max-w-md mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
        <div class="bg-blue-600 dark:bg-blue-700 px-6 py-4">
            <h1 class="text-2xl font-bold text-white text-center">Welcome Back to Ajira Global</h1>
        </div>
        ...
        <div class="p-6">
            ...
            <div class="mt-6">
                ...
                <div class="mt-6 grid grid-cols-2 gap-3">
                    <a href="#" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
