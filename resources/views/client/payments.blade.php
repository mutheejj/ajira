...
@section('title', 'Payment History | Ajira Global')
    ...
    <div class="flex flex-col md:flex-row gap-6">
        ...
        <div class="w-full md:w-64 bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            ...
            <nav class="space-y-1">
                ...
                <a href="{{ route('client.payments') }}" class="flex items-center px-3 py-2 bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-200 rounded-md font-medium">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div class="flex-1">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                <h1 class="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Payment History</h1>
                ...
                <div class="text-center py-12">
                    ...
                    <p class="text-lg font-medium text-gray-700 dark:text-gray-300">No payment history yet</p>
                    <p class="text-gray-500 dark:text-gray-400 mt-2">When you make payments to freelancers, your payment history will appear here.</p>
                    <a href="{{ route('client.active-contracts') }}" class="mt-4 inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
