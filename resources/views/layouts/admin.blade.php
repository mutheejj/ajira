...
<body class="min-h-screen bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-white transition-colors duration-300" id="app-body">
            ...
            <div class="p-4">
                ...
                <div class="my-4 flex justify-center">
                    <button id="theme-toggle-desktop" 
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 hidden" viewBox="0 0 20 20" fill="currentColor" id="theme-toggle-dark-icon-desktop">
                            <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z" />
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 hidden" viewBox="0 0 20 20" fill="currentColor" id="theme-toggle-light-icon-desktop">
    ...
    <script>
        ...
        if (localStorage.getItem('color-theme') === 'dark' || 
            ...
            document.getElementById('theme-toggle-light-icon-desktop')?.classList.remove('hidden'); // Desktop icon
        } else {
            document.documentElement.classList.remove('dark');
            themeToggleDarkIcon.classList.remove('hidden');
            document.getElementById('theme-toggle-dark-icon-desktop')?.classList.remove('hidden'); // Desktop icon
        }
        ...
        const handleThemeToggle = () => {
            ...
            document.getElementById('theme-toggle-dark-icon-desktop')?.classList.toggle('hidden');
            document.getElementById('theme-toggle-light-icon-desktop')?.classList.toggle('hidden');
